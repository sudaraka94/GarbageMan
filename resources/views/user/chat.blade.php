        ...
        <div class="row">
            ...
            <div class="conversation-wrap col-lg-3">
                ...
                @foreach($complaints as $complaint)
                    <a href="{{route('user_complaints',['id'=>$complaint->id])}}">
                        <div class="media conversation">
                            <div class="pull-left">
                                <img class="media-object" alt="user Image" style="width: 50px; height: 50px;" src="{{asset('img/user.png')}}">
                            </div>
                            <div class="media-body">
                                <h5 class="media-heading">{{$complaint->user->name}}@if($complaint->new==1) <span class="label label-success">New</span> @endif</h5>
            ...
            <div class="message-wrap col-lg-8">
                ...
                <form action="{{route('user_post_reply')}}" method="post">
                    <div class="send-wrap ">
